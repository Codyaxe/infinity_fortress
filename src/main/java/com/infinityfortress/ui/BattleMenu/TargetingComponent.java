...
public class TargetingComponent extends SelectionUI {
    ...
    private void layoutRow(StringBuilder frame, ArrayList<NCharacter> rowTargets, int yPos, int startX, int width, int[][] coords, int coordOffset) {
        ...
        for (int i = 0; i < rowTargets.size(); i++) {
            ...
            if (i < rowTargets.size() - 1) frame.append(" ".repeat(spaceBetween));
