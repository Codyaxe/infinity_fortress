...
public class InfoComponent {
  ...
  public StringBuilder displayBasicSkill(NCharacter curr) {
    ...
    frame.append("\033[20;57H│").append(" ".repeat(selectionSize)).append("│ ").append(
        Utils.leftAlign(
            Utils.spaceBetween("Success: ",
                "" + String.format("%d%%", DerivedStatCalculation.successRate(curr.getLuck())), (int) infoSize / 2 - 3),
            infoSize - 2))
        .append(" │");

    frame.append("\033[21;57H│").append(" ".repeat(selectionSize)).append("│").append(" ".repeat(infoSize)).append("│");
    frame.append("\033[22;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign("Description: ", infoSize - 2)).append(" │");

    String[] temp = Utils.createTextGrid(descSize, infoSize, curr.getBasicAction().getStatDescription());
    for (int i = 0; i < descSize; i++)
      frame.append("\033[").append(23 + i).append(";57H│").append(" ".repeat(selectionSize)).append("│ ")
          .append(Utils.leftAlign(temp[i], infoSize - 2)).append(" │");
  ...
  public StringBuilder displayEquipment(NCharacter curr) {
    ...
    frame.append("\033[18;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign("Weapon: ", infoSize - 2)).append(" │");
    frame.append("\033[19;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign(curr.getEquipment().getWeapon().getName(), infoSize - 2)).append(" │");
    frame.append("\033[20;57H│").append(" ".repeat(selectionSize)).append("│").append(" ".repeat(infoSize)).append("│");

    frame.append("\033[21;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign("Armor: ", infoSize - 2)).append(" │");
    frame.append("\033[22;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign(curr.getEquipment().getArmor().getName(), infoSize - 2)).append(" │");
    frame.append("\033[23;57H│").append(" ".repeat(selectionSize)).append("│").append(" ".repeat(infoSize)).append("│");

    frame.append("\033[24;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign("Accessory 1: ", infoSize - 2)).append(" │");
    frame.append("\033[25;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign(curr.getEquipment().getAccessory1().getName(), infoSize - 2)).append(" │");
    frame.append("\033[26;57H│").append(" ".repeat(selectionSize)).append("│").append(" ".repeat(infoSize)).append("│");

    frame.append("\033[27;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign("Accessory 2: ", infoSize - 2)).append(" │");
    frame.append("\033[28;57H│").append(" ".repeat(selectionSize)).append("│ ")
        .append(Utils.leftAlign(curr.getEquipment().getAccessory2().getName(), infoSize - 2)).append(" │");
    frame.append("\033[29;57H└").append("─".repeat(selectionSize)).append("┴").append("─".repeat(infoSize)).append("┘");
