...
public class SummonerWeaponFactory {
    public Equipment createGlimmeringTotem() {
        return new Equipment("Glimmering Totem", "Weapon", "idol", "Summoner", 7, 2, 0, 1, 0, 0, 4,
    ...
    public Equipment createWhisperingCodex() {
        return new Equipment("Whispering Codex", "Weapon", "spellbook", "Summoner", 11, 3, 0, 2, 0, 0, 6,
    ...
    public Equipment createStarwovenGrimoire() {
        return new Equipment("Starwoven Grimoire", "Weapon", "spellbook", "Summoner", 16, 5, 0, 3, 0, 0, 8,
    ...
    public Equipment createArcsainIdol() {
        return new Equipment("Arcsain Idol", "Weapon", "idol", "Summoner", 19, 6, 0, 4, 0, 0, 9,
    ...
    public Equipment createTotemOfTheDawn() {
        return new Equipment("Totem of the Dawn", "Weapon", "idol", "Summoner", 23, 8, 0, 5, 0, 0, 10,
    ...
    public Equipment createShadowbindTome() {
        return new Equipment("Shadowbind Tome", "Weapon", "idol", "Summoner", 26, 10, 0, 6, 0, 0, 10,
    ...
    public Equipment createSoulforgeLexicon() {
        return new Equipment("Soulforge Lexicon", "Weapon", "spellbook", "Summoner", 28, 12, 0, 7, 0, 0, 9,
    ...
    public Equipment createEffigyOfTheDamned() {
        return new Equipment("Effigy of the Damned", "Weapon", "idol", "Summoner", 28, 8, 0, 5, 0, 0, 15,
    ...
    public Equipment createAscSangreHeart() {
        return new Equipment("Asc Sangre Heart", "Weapon", "medallion", "Summoner", 35, 5, 5, 15, 0, 0, 10,
