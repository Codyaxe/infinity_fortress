...
public class MageWeaponFactory {
  // Added Temp Desc & Flavor
    public Equipment createAshenwoodWand() {
        return new Equipment("Ashenwood Wand", "Weapon", "staff", "Mage", 5, 2, 0, 3, 0, 0, 0,
    ...
    public Equipment createGlimmerrootStaff() {
        return new Equipment("Glimmerroot Staff", "Weapon", "staff", "Mage", 8, 3, 0, 5, 0, 0, 0,
    ...
    public Equipment createFrostpetalWand() {
        return new Equipment("Frostpetal Wand", "Weapon", "staff", "Mage", 13, 5, 0, 8, 0, 0, 0,
    ...
    public Equipment createSolarisChanneler() {
        return new Equipment("Solaris Channeler", "Weapon", "staff", "Mage", 15, 7, 0, 8, 0, 0, 0,
    ...
    public Equipment createRuneboundStaff() {
        return new Equipment("Runebound Staff", "Weapon", "staff", "Mage", 19, 10, 0, 9, 0, 0, 0,
    ...
    public Equipment createEchoheartFocus() {
        return new Equipment("Echoheart Focus", "Weapon", "prism", "Mage", 20, 5, 0, 7, 5, 3, 0,
    ...
    public Equipment createStarcallersBeacon() {
        return new Equipment("Starcaller's Beacon", "Weapon", "catalyst", "Mage", 23, 6, 0, 7, 5, 5, 0,
    ...
    public Equipment createOblivionScepter() {
        return new Equipment("Oblivion Scepter", "Weapon", "staff", "Mage", 26, -5, 5, 16, 5, 5, 0,
    ...
    public Equipment createLuminousSpire() {
        return new Equipment("Luminous Spire", "Weapon", "staff", "Mage", 29, 14, 0, 15, 0, 0, 0,
    ...
    public Equipment createChaosveilCatalyst() {
        return new Equipment("Chaosveil Catalyst", "Weapon", "catalyst", "Mage", 29, 10, 0, 14, -5, 10, 0,
    ...
    public Equipment createEterniumSoulspire() {
        return new Equipment("Eternium Soulspire", "Weapon", "staff", "Mage", 30, 5, 0, 10, 10, 5, 0,
    ...
    public Equipment createAscMagusAeonPrism() {
        return new Equipment("Asc Magus Aeon Prism", "Weapon", "prism", "Mage", 40, 10, 5, 15, 5, 5, 0,
