...
public class Debuffers {
    public Consumables createWeakeningPoison() {
        return new Consumables("Weakening Poison", "Debuffer", "Any", 12, 3, 0, 0, -3, 0, 0, 0, 0, 0,
    ...
    public Consumables createAcidVial() {
        return new Consumables("Acid Vial", "Debuffer", "Any", 12, 3, 0, -3, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createCursingHex() {
        return new Consumables("Cursing Hex", "Debuffer", "Any", 18, 4, 0, 0, 0, 0, 0, -5, 0, 0,
    ...
    public Consumables createParalysisSerum() {
        return new Consumables("Paralysis Serum", "Debuffer", "Any", 25, 2, 0, -5, -5, -10, 0, 0, 0, 0,
    ...
    public Consumables createManaLeech() {
        return new Consumables("Mana Leech", "Debuffer", "Any", 20, 4, -3, 0, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createDeathsBane() {
        return new Consumables("Death's Bane", "Debuffer", "Any", 35, 3, -5, -7, -7, -15, -10, -7, 0, 0,
    ...
    public Consumables createVoidEssence() {
        return new Consumables("Void Essence", "Debuffer", "Any", 60, 4, -10, -15, -15, -25, -20, -15, 0, 0,
    ...
    public Consumables createSilencePotion() {
        return new Consumables("Silence Potion", "Debuffer", "Any", 22, 3, -10, 0, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createBlindingDust() {
        return new Consumables("Blinding Dust", "Debuffer", "Any", 16, 3, 0, 0, 0, -20, 0, -3, 0, 0,
