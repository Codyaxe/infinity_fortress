...
public class Boosters {
    public Consumables createStrengthBrew() {
        return new Consumables("Strength Brew", "Booster", "Any", 15, 0, 0, 5, 0, 0, 0,
    ...
    public Consumables createDefenseOintment() {
        return new Consumables("Defense Ointment", "Booster", "Any", 15, 0, 5, 0, 0, 0, 0,
    ...
    public Consumables createLuckCharm() {
        return new Consumables("Luck Charm", "Booster", "Any", 20, 0, 0, 0, 0, 0, 5,
    ...
    public Consumables createCriticalElixir() {
        return new Consumables("Critical Elixir", "Booster", "Any", 25, 0, 0, 0, 10, 5, 0,
    ...
    public Consumables createWarriorsVigor() {
        return new Consumables("Warrior's Vigor", "Booster", "Warrior", 30, 0, 3, 7, 5, 0, 0,
    ...
    public Consumables createMagesInsight() {
        return new Consumables("Mage's Insight", "Booster", "Mage", 30, 5, 0, 0, 0, 0, 3,
    ...
    public Consumables createArchersZen() {
        return new Consumables("Archer's Zen", "Booster", "Archer", 30, 0, 0, 3, 15, 7, 5,
    ...
    public Consumables createBerserkerRage() {
        return new Consumables("Berserker Rage", "Booster", "Any", 40, 0, -5, 15, 20, 10, 0,
    ...
    public Consumables createDivineBlessing() {
        return new Consumables("Divine Blessing", "Booster", "Any", 75, 10, 10, 10, 15, 15, 10,
