...
public class Utilities {
    public Consumables createAntidote() {
        return new Consumables("Antidote", "Utility", "Any", 8, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createCleansingWater() {
        return new Consumables("Cleansing Water", "Utility", "Any", 12, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createSmokeGrenade() {
        return new Consumables("Smoke Grenade", "Utility", "Any", 15, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createFlashbang() {
        return new Consumables("Flashbang", "Utility", "Any", 18, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createTeleportationScroll() {
        return new Consumables("Teleportation Scroll", "Utility", "Any", 25, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createResurrectionPotion() {
        return new Consumables("Resurrection Potion", "Utility", "Any", 100, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createTimeShifter() {
        return new Consumables("Time Shifter", "Utility", "Any", 150, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createTrapDetector() {
        return new Consumables("Trap Detector", "Utility", "Any", 10, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createIdentificationLens() {
        return new Consumables("Identification Lens", "Utility", "Any", 20, 0, 0, 0, 0, 0, 0,
    ...
    public Consumables createRestoreSkillPotion() {
        return new Consumables("Restore Skill Potion", "Utility", "Any", 30, 0, 0, 0, 0, 0, 0,
