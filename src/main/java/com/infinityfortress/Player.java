...
import com.infinityfortress.items.consumables.Defensives;
import com.infinityfortress.items.consumables.Restoratives;
import com.infinityfortress.items.consumables.Offensives;
...
public class Player {
    ...
    public Player() {
        ...
        Defensives debuffersFactory = new Defensives();
        Offensives utilitiesFactory = new Offensives();
