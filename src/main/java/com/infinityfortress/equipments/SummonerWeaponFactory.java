...
public class SummonerWeaponFactory {
    Equipment createGlimmeringTotem() {
    ...
    Equipment createWhisperingCodex() {
    ...
    Equipment createStarwovenGrimoire() {
    ...
    Equipment createTotemOfTheDawn() {
    ...
    Equipment createShadowbindTome() {
    ...
    Equipment createSoulforgeLexicon() {
    ...
    Equipment createEffigyOfTheDamned() {
    ...
    Equipment createAscSangreHeart() {
