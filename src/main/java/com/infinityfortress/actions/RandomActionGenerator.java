...
public class RandomActionGenerator {
    ...
    public static Action generateRandomAction() {
        ...
        return new RandomAction(actionType, hitCount, baseDamage, manaCost, name, description, targetingType);
    }
    ...
    private static String getRandomActionType() {
        String[] actionTypes = {"Damage", "Heal", "Buff", "Debuff", "Summon", "Other"};
    ...
    private static class RandomAction implements Action {
        ...
        public RandomAction(String actionType, int hitCount, int baseDamage, int manaCost,
                String name, String description, TargetingType targetingType) {
