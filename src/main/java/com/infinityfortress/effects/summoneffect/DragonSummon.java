...
public class DragonSummon implements SummonEffect {
    private int damage;
    ...
    public DragonSummon(int duration) {
        this.damage = 10;
    ...
    public void execute(NCharacter owner, ArrayList<NCharacter> allies, ArrayList<NCharacter> enemies,
        ...
        Printbox.showMessage(battleUI, String.format("%s's Dragon strikes %s for %d damage!",
